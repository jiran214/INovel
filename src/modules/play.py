...
from src.modules.memory import PlayContext
...
class NovelSettings(BaseModel):
    ...
    def update_context(self, context: PlayContext):
        self.play_context_memory = context.play_context_memory
        self.play_context_window = context.play_context_window
